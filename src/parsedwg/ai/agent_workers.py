...
async def run_interpret_blocks_step(
    ...
    from src.parsedwg.db import get_file_id_by_source
    from src.parsedwg.ai_services import interpret_blocks
...
async def run_categorize_entities_step(
    ...
    from src.parsedwg.ai_services import categorize_entities
    from src.parsedwg.db import get_file_id_by_source
...
async def run_verify_extraction_step(
    ...
    from src.parsedwg.verify_extraction import verify_extraction
