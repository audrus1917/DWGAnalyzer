"""Helpers for finding table-like text structures in DXF blocks."""
...
class AxisCluster:
    """Cluster of nearby coordinates on a single axis."""
...
class TextClusterAnalyzer:
    """Analyze block text entities and detect table structure."""
